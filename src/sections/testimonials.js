...
const data = [
  {
    ...
    description:
      "Notice for ma'am. Thankyou ma'am for teaching us good things. The normal study is to manage life but this study is used life time.",
    avatar: Avatar1,
  ...
  },
  {
    ...
    description:
      "Thank you ma'am for always motivating. Learning from you ma'am was a great experience. You taught with great paitence and enthusiastically. Before learning from you neither I was able to express my views nor speak up frequently. But you really transformed me. You make me so confident about myself and always encourage me to do more. Your sessions were very interactive. And the thing I like the most about the course is Group discussions. Thank you ma'am for providing great knowledge to me.",
    avatar: Avatar2,
    image: StudentFeedback2,
    name: "Anishka Monika",
    designation: "12th class student",
    review: 5,
  },
  {
    id: 3,
    title: "Lovely Kid Feedback",
    description:
      "Neha ma'am is my favourite ma'am. Neha ma'am because they has some special quality. For example: cute, good, honest, clean heart and one important thing soft voice etc. Neha ma'am is very sweet and Neha ma'am is so much amazing!!! I love to ma'am beautiful hair and you all of know Neha's hair (WOW!) colour is golden and love my Neha ma'am.",
    avatar: Avatar3,
    image: StudentFeedback1,
    name: "Arish Rana",
    designation: "4th class student",
    review: 5,
  },
  // {
  //   id: 4,
